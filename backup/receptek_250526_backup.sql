...
101	101	172	50.00	8	11	6
102	102	51	60.00	8	4	6
103	103	122	80.00	8	8	6
104	104	55	70.00	8	4	6
2	2	2	\N	2	1	1
\.
...
101	Mákostészta	Főzz tésztát sós vízben, kevés étolajjal, szűrd le, tálald mákkal és porcukorral	Retró magyar étel	6	Víz	Étolaj	Nincs	Nincs	Nincs	Nincs	Száraztészta	Nincs	Nincs	Só	Mák	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs
102	Töltött paprika	Csumázz ki szép, nagy paprikákat, töltsd meg rizzsel és darálthússal, fűszerezve, főzd meg paradicsomszószban	Családi, nyári fogás	6	Víz	Étolaj	Darált sertéshús	Paprika	Nincs	Rizs	Nincs	Nincs	Nincs	SVegeta	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs
103	Babgulyás	Főzz babot, marhahússal és zöldségekkel, tálald friss kenyérrel	Apa kedvence	6	Víz	Étolaj	Marha	Burgonya	Nincs	Nincs	Nincs	Nincs	Nincs	Pirospaprika	Nincs	Nincs	Fehér kenyér	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs
104	Káposztás tészta	Főzz száraztésztát, dinsztelj káposztát pirosra, fűszerezd sóval, borssal, keverd össze a leszűrt tésztával	Vigyázz, könnyen odakap!	6	Víz	Étolaj	Nincs	Fejes káposzta	Nincs	Nincs	Kockatészta	Nincs	Nincs	Fekete bors	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs	Nincs
\.
